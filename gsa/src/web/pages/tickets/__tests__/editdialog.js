...
describe('EditTicketDialog component tests', () => {
  ...
  test('should display notes', () => {
    ...
    expect(baseElement.querySelector('[name=openNote]'))
      .toHaveTextContent('Ticket has been opened');
    expect(baseElement.querySelector('[name=closedNote]'))
      .toHaveTextContent('Ticket has been closed');
    expect(baseElement.querySelector('[name=fixedNote]'))
      .toHaveTextContent('Ticket has been fixed');
  });
