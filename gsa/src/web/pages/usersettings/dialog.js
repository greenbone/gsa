...
import {renderOptions} from '../../utils/render.js';
            ...
            {capabilities.mayAccess('report_formats') &&
              <FormGroup title={_('Default Report Format')} titleSize="3">
                <Select
                  ...
                  size="30"
                  onChange={onValueChange}>
                  {renderOptions(reportformatsList, '')}
                </Select>
              </FormGroup>
            }
              ...
              <div>
                ...
                <FormGroup title={_('Agents Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.agent, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Alerts Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.alert, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Assets Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.asset, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Configs Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.config, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Credentials Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.credential, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Filters Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.filter, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Notes Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.note, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Overrides Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.override, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Permissions Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.permission, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Port List Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.portlist, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Reports Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.report, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Report Formats Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.reportformat, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Results Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.result, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Roles Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.role, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Schedules Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.schedule, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Targets Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.target, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('Tasks Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.task, '')}
                  </Select>
                </FormGroup>
                ...
                <FormGroup title={_('CPE Filter')} titleSize="3">
                  <Select
                    ...
                    size="30"
                    onChange={onValueChange}>
                    {renderOptions(filtersList.secinfo, '')}
                  </Select>
                </FormGroup>
