...
export const createAlertInput = startDate => {
  return {
    input: {
      name: `Email Alert for myFirstTask - ${startDate.toISOString()}`,
      comment: 'Automatically generated by wizard',
...
export const createWizardAlertQueryMock = (startDate = mockDate, errors) =>
  createGenericQueryMock(
    CREATE_ALERT,
    createAlertResult,
