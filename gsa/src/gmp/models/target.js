...
export const HYPERION_ALIVE_TESTS = {
  // enum for target mutations
  SCAN_CONFIG_DEFAULT: 'SCAN_CONFIG_DEFAULT',
  ICMP_PING: 'ICMP_PING',
  TCP_ACK_SERVICE_PING: 'TCP_ACK_SERVICE_PING',
  TCP_SYN_SERVICE_PING: 'TCP_SYN_SERVICE_PING',
  ARP_PING: 'ARP_PING',
  ICMP_AND_TCP_ACK_SERVICE_PING: 'ICMP_AND_TCP_ACK_SERVICE_PING',
  ICMP_AND_ARP_PING: 'ICMP_AND_ARP_PING',
  TCP_ACK_SERVICE_AND_ARP_PING: 'TCP_ACK_SERVICE_AND_ARP_PING',
  ICMP_TCP_ACK_SERVICE_AND_ARP_PING: 'ICMP_TCP_ACK_SERVICE_AND_ARP_PING',
