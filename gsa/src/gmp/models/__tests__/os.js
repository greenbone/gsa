...
describe('OperatingSystem model tests', () => {
  ...
  test('should parse os severities or return undefined', () => {
    ...
    expect(os1.average_severity).toEqual(parseSeverity('7'));
    expect(os1.latest_severity).toEqual(parseSeverity('8'));
    expect(os1.highest_severity).toEqual(parseSeverity('8.5'));
