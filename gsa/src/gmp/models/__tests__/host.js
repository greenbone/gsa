...
describe('Host model parseObject tests', () => {
  test('should be instance of Asset', () => {
    const host = Host.fromObject({});

    expect(host).toBeInstanceOf(Asset);
  });

  test('should return empty array if no identifiers are given', () => {
    const host = Host.fromObject({});
  ...
  test('should return hostname identifier, set alternative or undefined', () => {
    ...
    const host = Host.fromObject(obj);
    const host2 = Host.fromObject(obj2);
    const host3 = Host.fromObject(obj3);
  ...
  test('should parse best_os_cpe', () => {
    ...
    const host1 = Host.fromObject(obj1);
    const host2 = Host.fromObject(obj2);
    const host3 = Host.fromObject(obj3);
    const host4 = Host.fromObject(obj4);
...
describe('Host model parseElement tests', () => {
  test('should be instance of Asset', () => {
