...
char * create_report_omp (openvas_connection_t *, credentials_t *,
                          params_t *, cmd_response_data_t*);
char * upload_report_omp (openvas_connection_t *, credentials_t *,
                          params_t *, cmd_response_data_t*);
char * import_report_omp (openvas_connection_t *, credentials_t *,
                          params_t *, cmd_response_data_t*);
char * create_container_task_omp (openvas_connection_t *,
                                  credentials_t *, params_t *,
                                  cmd_response_data_t *);
char * create_task_omp (openvas_connection_t *, credentials_t *,
                        params_t *, cmd_response_data_t*);
char * delete_task_omp (openvas_connection_t *, credentials_t *,
                        params_t *, cmd_response_data_t*);
char * delete_trash_task_omp (openvas_connection_t *, credentials_t *,
                              params_t *, cmd_response_data_t*);
char * edit_task_omp (openvas_connection_t *, credentials_t *,
                      params_t *, cmd_response_data_t*);
char * new_container_task_omp (openvas_connection_t *,
                               credentials_t *, params_t *,
                               cmd_response_data_t*);
char * new_task_omp (openvas_connection_t *, credentials_t *,
                     params_t *, cmd_response_data_t*);
char * save_task_omp (openvas_connection_t *, credentials_t *,
                      params_t *, cmd_response_data_t*);
char * save_container_task_omp (openvas_connection_t *,
                                credentials_t *, params_t *,
                                cmd_response_data_t*);
char * resume_task_omp (openvas_connection_t *, credentials_t *,
                        params_t *, cmd_response_data_t*);
char * start_task_omp (openvas_connection_t *, credentials_t *,
                       params_t *, cmd_response_data_t*);
char * stop_task_omp (openvas_connection_t *, credentials_t *,
                      params_t *, cmd_response_data_t*);
char * move_task_omp (openvas_connection_t *, credentials_t *,
                      params_t *, cmd_response_data_t*);

char * get_task_omp (openvas_connection_t *, credentials_t *,
                     params_t *, cmd_response_data_t*);
char * get_tasks_omp (openvas_connection_t *, credentials_t *,
                      params_t *, cmd_response_data_t*);
...
char * get_report_section_omp (openvas_connection_t *,
                               credentials_t *, params_t *,
                               cmd_response_data_t*);
...
char * new_alert_omp (openvas_connection_t *, credentials_t *,
                      params_t *, cmd_response_data_t*);
char * create_alert_omp (openvas_connection_t *, credentials_t *,
                         params_t *, cmd_response_data_t*);
char * delete_alert_omp (openvas_connection_t *, credentials_t *,
                         params_t *, cmd_response_data_t*);
char * delete_trash_alert_omp (openvas_connection_t *,
                               credentials_t *, params_t *,
                               cmd_response_data_t*);
char * test_alert_omp (openvas_connection_t *, credentials_t *,
                       params_t *, cmd_response_data_t*);
char * get_alert_omp (openvas_connection_t *, credentials_t *,
                      params_t *, cmd_response_data_t*);
char * edit_alert_omp (openvas_connection_t *, credentials_t *,
                       params_t *, cmd_response_data_t*);
char * save_alert_omp (openvas_connection_t *, credentials_t *,
                       params_t *, cmd_response_data_t*);
...
char * delete_config_omp (openvas_connection_t *, credentials_t *, params_t *,
                          cmd_response_data_t*);
char * delete_trash_config_omp (openvas_connection_t *, credentials_t *,
                                params_t *, cmd_response_data_t*);
...
char * get_trash_omp (openvas_connection_t *, credentials_t *, params_t *params,
                      cmd_response_data_t*);
