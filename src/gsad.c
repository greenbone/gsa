...
init_validator ()
{
  ...
  openvas_validator_alias (validator, "report_format_ids:name",  "number");
  openvas_validator_alias (validator, "report_format_ids:value", "report_format_id");
...
main (int argc, char **argv)
{
  ...
  static int per_ip_connection_limit_arg = DEFAULT_GSAD_PER_IP_CONNECTION_LIMIT;
  ...
  static GOptionEntry option_entries[] = {
    ...
    {"per-ip-connection-limit", '\0',
     0, G_OPTION_ARG_INT, &per_ip_connection_limit_arg,
  ...
  if (per_ip_connection_limit_arg >= 0)
    per_ip_connection_limit = per_ip_connection_limit_arg;
  else
    per_ip_connection_limit = DEFAULT_GSAD_PER_IP_CONNECTION_LIMIT;
