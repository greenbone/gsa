...
init_validator ()
{
  ...
  openvas_validator_add (validator, "details_fname", "^([[:alnum:]_-]|%[%CcDMmTtUu])+$");
  ...
  openvas_validator_add (validator, "list_fname", "^([[:alnum:]_-]|%[%CcDMmTtUu])+$");
  ...
  openvas_validator_add (validator, "report_fname", "^([[:alnum:]_-]|%[%CcDMmTtUu])+$");
