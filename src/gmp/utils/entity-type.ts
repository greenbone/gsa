...
const NORMALIZE_TYPES = {
  ...
  oci_image_target: 'ociimagetarget',
  os: 'operatingsystem',
  web_application_target: 'webapplicationtarget',
  port_list: 'portlist',
...
const ENTITY_TYPES = {
  ...
  host: _l('Host'),
  info: _l('Info'),
  ociimagetarget: _l('OCI Image Target'),
...
const ENTITY_TO_API_TYPES = {
  ...
  host: 'asset',
  nvt: 'info',
  ociimagetarget: 'oci_image_target',
  operatingsystem: 'asset',
  webapplicationtarget: 'web_application_target',
  policy: 'config',
  portlist: 'port_list',
