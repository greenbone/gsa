      ...
      <xsl:choose>
        <xsl:when test="count(report/results/result) &gt; 0">
          ...
          <xsl:if test = "report/results/@start &gt; 1">
            <xsl:choose>
              <xsl:when test="../../delta">
                <a class="gb_window_part_center" href="?cmd=get_report&amp;delta_report_id={../../delta}&amp;report_id={report/@id}&amp;first_result={report/results/@start - report/results/@max}&amp;max_results={report/results/@max}&amp;levels={$levels}&amp;sort_field={report/sort/field/text()}&amp;sort_order={report/sort/field/order}&amp;notes={report/filters/notes}&amp;overrides={report/filters/overrides}&amp;result_hosts_only={report/filters/result_hosts_only}&amp;delta_states={report/filters/delta/text()}&amp;token={/envelope/token}">&lt;&lt;</a>
              </xsl:when>
              <xsl:otherwise>
  ...
  <div class="note_box_box">
    ...
    <xsl:if test="$note-buttons = 1">
      <div class="float_right" style="text-align:right">
        ...
        <xsl:choose>
          <xsl:when test="$next='get_result'">
            <a href="/omp?cmd=edit_note&amp;note_id={@id}&amp;next=get_result&amp;result_id={../../@id}&amp;task_id={../../../../../../task/@id}&amp;name={../../../../../../task/name}&amp;report_id={../../../../../../report/@id}&amp;first_result={../../../../../../results/@start}&amp;max_results={../../../../../../results/@max}&amp;sort_field={../../../../../../sort/field/text()}&amp;sort_order={../../../../../../sort/field/order}&amp;levels={../../../../../../filters/text()}&amp;notes={../../../../../../filters/overrides}&amp;overrides={../../../../../../filters/overrides}&amp;result_hosts_only={../../../../../../filters/result_hosts_only}&amp;search_phrase={../../../../../../filters/phrase}&amp;min_cvss_base={../../../../../../filters/min_cvss_base}&amp;apply_min_cvss_base={string-length (../../../../../../filters/min_cvss_base) &gt; 0}&amp;token={/envelope/token}"
               title="Edit Note"
               style="margin-left:3px;">
              <img src="/img/edit.png" border="0" alt="Edit"/>
            </a>
    ...
    <xsl:if test="$override-buttons = 1">
      <div class="float_right" style="text-align:right">
        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            <a href="/omp?cmd=edit_override&amp;override_id={@id}&amp;next=get_report&amp;report_id={../../../../@id}&amp;first_result={../../../../results/@start}&amp;max_results={../../../../results/@max}&amp;sort_field={../../../../sort/field/text()}&amp;sort_order={../../../../sort/field/order}&amp;levels={../../../../filters/text()}&amp;notes={../../../../filters/notes}&amp;overrides=1&amp;result_hosts_only={../../../../filters/result_hosts_only}&amp;search_phrase={../../../../filters/phrase}&amp;min_cvss_base={../../../../filters/min_cvss_base}&amp;apply_min_cvss_base={string-length (../../../../filters/min_cvss_base) &gt; 0}&amp;token={/envelope/token}"
               title="Edit Override"
               style="margin-left:3px;">
              <img src="/img/edit.png" border="0" alt="Edit"/>
            </a>
      ...
      <div class="float_right" style="text-align:right">
        ...
        <xsl:choose>
          ...
          <xsl:when test="$result-details and original_threat and string-length (original_threat)">
            <a href="/omp?cmd=new_note&amp;next=get_result&amp;report_id={@id}&amp;result_id={@id}&amp;oid={nvt/@oid}&amp;task_id={../../../../task/@id}&amp;name={../../../../task/name}&amp;threat={original_threat}&amp;port={port}&amp;hosts={host/text()}&amp;overrides={../../../../filters/apply_overrides}&amp;token={/envelope/token}"
    ...
    <xsl:if test="$override-buttons = 1">
      <div class="float_right" style="text-align:right">
        ...
        <xsl:choose>
          ...
          <xsl:when test="$result-details and original_threat and string-length (original_threat)">
            <a href="/omp?cmd=new_override&amp;next=get_result&amp;report_id={@id}&amp;result_id={@id}&amp;oid={nvt/@oid}&amp;task_id={../../../../task/@id}&amp;name={../../../../task/name}&amp;threat={original_threat}&amp;port={port}&amp;hosts={host/text()}&amp;overrides={../../../../filters/apply_overrides}&amp;token={/envelope/token}"
