      ...
      <Layout flex="column">
        ...
        >
          <StyledLayout align="center" flex="column">
            ...
            <DivP>
              {_(
                'The OPENVAS SCAN is the web-based ' +
                  'user interface of the OPENVAS Community Edition.',
              )}
            </DivP>
            <DivP>
              {_(
                'OPENVAS SCAN uses the Greenbone Management Protocol (GMP) to connect to' +
            ...
            <DivP>
              {_(
                'OPENVAS SCAN adds various smart features and forms a powerful tool ' +
