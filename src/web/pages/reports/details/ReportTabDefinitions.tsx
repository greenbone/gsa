...
export const TAB_KEYS = {
  ...
  os: 'os',
  cves: 'cves',
  closedcves: 'closedcves',
  tlscerts: 'tlscerts',
  errors: 'errors',
  usertags: 'usertags',
} as const;

// Keys for tabs that should be excluded for web application scanning
export const EXCLUDED_WEBAPP_TAB_KEYS = [
  TAB_KEYS.applications,
  TAB_KEYS.os,
  TAB_KEYS.cves,
  TAB_KEYS.closedcves,
  TAB_KEYS.tlscerts,
...
const EXCLUDED_WEBAPP_TAB_KEY_SET = new Set<string>(
  EXCLUDED_WEBAPP_TAB_KEYS as readonly string[],
);
...
export const buildReportTabDefinitions = ({
  ...
  [
    ...
    },
    {
      ...
      renderTab: () => (
        <TabTitle
          ...
          isLoading={
            reportEntities.cves.isFetching && !reportEntities.cves.data
          }
          title={_('CVEs')}
        />
      ),
    ...
    tab =>
      !isWebApplicationScanning || !EXCLUDED_WEBAPP_TAB_KEY_SET.has(tab.key),
  );
