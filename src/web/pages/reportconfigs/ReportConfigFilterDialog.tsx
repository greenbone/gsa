...
interface ReportConfigsFilterDialogProps extends UseFilterDialogSaveProps {
  filter?: Filter;
}

const ReportConfigFilterDialog = ({
  filter,
  onClose,
  onFilterChanged,
  onFilterCreated,
}: ReportConfigsFilterDialogProps) => {
...
export default ReportConfigFilterDialog;
