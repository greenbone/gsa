...
import WebApplicationTargetTableHeader from 'web/pages/web-application-targets/WebApplicationTargetTableHeader';

describe('WebApplicationTargetTableHeader tests', () => {
  test('should render the table header', () => {
    const handleSortChange = testing.fn();
    const {render} = rendererWithTable();
    render(
      <WebApplicationTargetTableHeader
        currentSortBy="name"
        currentSortDir="asc"
        sort={true}
