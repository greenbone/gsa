...
describe('Arc class tests', () => {
  ...
  test('should match paths for full circle', () => {
    ...
    a.innerRadiusX(50);
    expect(String(a.path())).toMatchSnapshot();
  ...
  test('should match paths for arc', () => {
    const a = arc().outerRadiusX(100);
    const testArc = {startAngle: 1, endAngle: 2.5};

    let path = a.path(testArc).toString();
    expect(path).toMatchSnapshot();

    a.innerRadiusX(50);
    path = a.path(testArc).toString();
    expect(path).toMatchSnapshot();
  ...
  test('should draw empty path for no angle', () => {
    const a = arc().outerRadiusX(100);
    const testArc = {startAngle: 1, endAngle: 1};
