...
### Added
- Added @testing-library/user-event as a dev-dependency [#2912](https://github.com/greenbone/gsa/pull/2912)
...
### Fixed
- Fix setting secret key in RADIUS dialog [#2912](https://github.com/greenbone/gsa/pull/2912)
- Fix setting result UUID in notes dialog [#2889](https://github.com/greenbone/gsa/pull/2889)

### Removed

[Unreleased]: https://github.com/greenbone/gsa/compare/v20.8.1...gsa-20.08
