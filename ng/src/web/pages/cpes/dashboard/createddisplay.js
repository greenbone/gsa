...
export const CpesCreatedDisplay = ({
  filter,
  ...props
}) => (
  <CpesCreatedLoader
...
CpesCreatedDisplay.propTypes = {
  filter: PropTypes.filter,
};

CpesCreatedDisplay.displayId = 'cpe-by-created';


export const CpesCreatedTableDisplay = ({
  filter,
  ...props
}) => (
  <CpesCreatedLoader
...
CpesCreatedTableDisplay.propTypes = {
  filter: PropTypes.filter,
};

CpesCreatedTableDisplay.displayId = 'cpe-by-created-table';
